...
public class Discotienda
{
    ...
    */
    public void generarInformeDiscos() throws FileNotFoundException
    {
        ...
        //escribir un reporte de discos con nombre, artistas y genero 
       
        //recodito toal sobre discos
        for (int i = 0; i < discos.size(); i++) {

            //entrar en la informacion de cada disco
            Disco miDisco=(Disco)discos.get(i);

            //escribir con la pluma la informacion requerida 
            pluma.println("Nombre: "+ miDisco.darNombreDisco()+"      Artista: "+miDisco.darArtista()+"       Genero: "+miDisco.darGenero()+"      precio:"+miDisco.darPrecioDisco());
    ...
    public String generarInformeDiscosEconomicosRockyPop()throws FileNotFoundException
    {
        int numeroDiscos=0;
        // crear el archivo con la clase FILE
        ...
        //escribir un reporte de de todos los discos de un género ROCK y POP con precio menor a 1000
       
        //recodito toal sobre discos
        for (int i = 0; i < discos.size(); i++) {

           
            //entrar en informacion de cada disco
            Disco miDisco=(Disco)discos.get(i);

            //condiciones necesarias para generar el reporte
        ...
        //retornar si se encontro o no discos con las condiciones 
        if (numeroDiscos==0) {
    ...
    public String metodo1( )
    {
        try {
            ...
            return "Reporte generado satifatoriamente ";
        } catch (Exception e) {
    ...
    public String metodo2( )
    {
    	try {
            ...
            return generarInformeDiscosEconomicosRockyPop();
        } catch (Exception e) {
